...
public class FactoryManager : MonoBehaviour
{
    ...
    [System.NonSerialized] public Transform factoryMarker;
    ...
    [System.NonSerialized] public FlowField resourceNavigator;

    Camera mainCam;

    public Map map;

    public void SetDependencies(IInput input, IBotManager botManager)
    {
        _input = input;
    ...
    private void Awake()
    {
        SetDependencies(new EngineInput(), GetComponent<BotManager>());
    ...
    internal void HandleInput()
    {
        ...
        {
            Vector2Int tile = _input.GetTilePosition(factoryMarker);
